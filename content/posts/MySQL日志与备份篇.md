---
title: "MySQL日志与备份篇"
date: 2022-10-22T10:39:18+08:00
tags: []
categories: [mysql]
draft: false
---
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220931856.png" alt="image-20220715141705004" style="float:left;" />
...
MySQL有不同类型的日志文件，用来存储不同类型的日志，分为 `二进制日志` 、 `错误日志` 、 `通用查询日志` 和 `慢查询日志` ，这也是常用的4种。MySQL8又新增两种支持的日志：中继日志和数据定义语句日志。使用这些日志文件，可以查看MySQL内部发生的事情。
...
* **二进制日志**：记录所有**更改数据的语句**，可以用于主从服务器之间的数据同步，以及服务器遇到故障时数据的无损失恢复。 
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220937599.png" alt="image-20220715145650406" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220940047.png" alt="image-20220715155010381" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221038645.png" alt="image-20220715160249271" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220945467.png" alt="image-20220715160657093" style="float:left;" />
...
* 第二步：重建日志
  ...
  ![image-20220715161132368](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220946893.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220946768.png" alt="image-20220715161216556" style="float:left;" />

### 4.4 MySQL 8.0 新特性

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220946355.png" alt="image-20220715161321565" style="float:left;" />
...
binlog主要应用场景：<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220947654.png" alt="image-20220715161800635" style="zoom:100%;" />

![image-20220715161842703](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220948007.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220951470.png" alt="image-20220715163520596" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220954413.png" alt="image-20220715163811664" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210220958087.png" alt="image-20220715164107352" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221001455.png" alt="image-20220715164718970" style="float:left;" />

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221002481.png" alt="image-20220715164743351" style="float:left;" />

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221002976.png" alt="image-20220715164809401" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221003450.png" alt="image-20220715165603879" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221004885.png" alt="image-20220715171712026" style="float:left;" />

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221004873.png" alt="image-20220715172015185" style="float:left;" />

**2. RESET MASTER: 删除所有二进制日志文件**

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221004689.png" alt="image-20220715172104967" style="float:left;" />
...
binlog的写入时机也非常简单，事务执行过程中，先把日志写到 `binlog cache` ，事务提交的时候，再把binlog cache写到binlog文件中。因为一个事务的binlog不能被拆开，无论这个事务多大，也要确保一次性写入，所以系统会给每个线程分配一个块内存作为binlog cache。(保证了事务的原子性)

我们可以通过`binlog_cache_size`参数控制单个线程 `binlog cache` 大小，如果存储内容超过了这个参数，就要暂存到磁盘（Swap）。binlog日志刷盘流程如下：

![image-20220715172958729](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221007196.png)
...
![image-20220715193749462](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221013920.png)

为了安全起见，可以设置为 `1` ，表示每次提交事务都会执行fsync，就如同**redo log 刷盘流程**一样。 

最后还有一种折中方式，可以设置为N(N>1)，表示每次提交事务都write，但累积N个事务后才fsync。

![image-20220715194624080](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221015462.png)
...
在执行更新语句过程，会记录redo log与binlog两块日志，以基本的事务为单位，redo log在事务执行过程中可以不断写入，而binlog只有在提交事务时才会从binlog cache写入，所以redo log与binlog的 `写入时机` 不一样。

![image-20220715194959405](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221015121.png)
...
![image-20220715195016492](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221018976.png)

由于binlog没写完就异常，这时候binlog里面没有对应的修改记录。因此，之后用binlog日志恢复数据或主从数据同步时，就会少这一次更新，恢复出来的这一行c值为0，而原库因为redo log日志恢复，这一行c的值是1，最终数据不一致。

![image-20220715195521986](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221020367.png)

为了解决两份日志之间的逻辑一致问题，InnoDB存储引擎使用**两阶段提交**方案。原理很简单，将redo log的写入拆成了两个步骤prepare和commit，这就是**两阶段提交**。

![image-20220715195635196](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221021830.png)

使用两阶段提交后，写入binlog时发生异常也不会有影响，因为MySQL根据redo log日志恢复数据时，发现redo log还处于prepare阶段，并且没有对应binlog日志，就会回滚该事务。

![image-20220715200248193](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221021267.png)

另一个场景，redo log设置commit阶段发生异常，那会不会回滚事务呢？

![image-20220715200321717](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221022408.png)
...
![image-20220715202237535](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221022022.png)
...
![image-20220715212521601](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221028955.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221031613.png" alt="image-20220715214055057" style="float:left;" />
...
![image-20220715215944767](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032359.png)
...
![image-20220715220037213](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032467.png)
...
![image-20220715220852836](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032514.png)
...
![image-20220718140722740](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032141.png)
...
![image-20220718140946747](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032371.png)
...
![image-20220718141825228](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032363.png)

如果报错：

![image-20220718141841862](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032871.png)
...
![image-20220718141951374](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032817.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032229.png" alt="image-20220718142045114" style="zoom:80%;" />
...
* 如何重新配置主从
  ...
  ![image-20220718142549168](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032769.png)
...
![image-20220718143705843](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032942.png)

![image-20220718143716620](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221032717.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033702.png" alt="image-20220718144051094" style="float:left;" />
...
![image-20220718144341584](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033009.png)
...
![image-20220718144410731](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033867.png)

#### 方法 2：半同步复制

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033760.png" alt="image-20220718144926758" style="float:left;" />

![image-20220718144958357](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033660.png)
...
![image-20220718145235499](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033436.png)
...
![image-20220718145428456](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221033670.png)
...
![image-20220718145523643](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034374.png)

![image-20220718145534856](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034663.png)

主备切换：

![image-20220718145548526](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034172.png)
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034798.png" alt="image-20220718145936444" style="float:left;" />
...
<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034187.png" alt="image-20220718163627669" style="float:left;" />
...
![image-20220718165515965](https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221034762.png)

## 8. 删库了不敢跑，能干点啥？

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221035723.png" alt="image-20220718165738367" style="float:left;" />

### 8.1 delete：误删行

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221035520.png" alt="image-20220718165909464" style="float:left;" />

### 8.2 truncate/drop ：误删库/表

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221035004.png" alt="image-20220718170026929" style="float:left;" />

### 8.3 预防使用truncate/drop误删库/表

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221035588.png" alt="image-20220718170132339" style="float:left;" />

<img src="https://raw.githubusercontent.com/cold-bin/img-for-cold-bin-blog/master/img/202210221035135.png" alt="image-20220718170215247" style="float:left;" />
